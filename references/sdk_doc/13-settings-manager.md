...
> **哪些类型能从包 import？** `@earendil-works/pi-coding-agent` 的入口（`index.ts`）仅 re-export 以下 7 个符号：`CompactionSettings`、`DefaultProjectTrust`、`ImageSettings`、`PackageSource`、`RetrySettings`、`SettingsManager`、`SettingsManagerCreateOptions`。
>
